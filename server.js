...
app.post('/api/checkout', (req, res) => {
    ...
    sales.unshift({ invoiceID: finalID, date: new Date().toLocaleString('en-IN'), customer, mobile, items, subtotal, tax, grandTotal });
...
app.listen(PORT, () => { initDB(); console.log(`🚀 Server ready: http://localhost:${PORT}`); });
